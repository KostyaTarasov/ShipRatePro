...
<body>
    <div>
        <div class="site">
                        ...
                        <div class="header-mobile">
                            ...
                            <div class="collapse navigation-menu" id="navbarToggleMenu">
                                ...
                                <ul class="navbar-nav navbar-list">
                                    <div class="dropend">
                                        <li><a class="dropdown-item navbar-text btn dropdown-toggle" data-bs-toggle="dropdown" aria-expanded="false">Компании</a>
                                            <ul class="dropdown-menu navigation-menu-catalog">
                                                ...
                                                <?php if (!empty($companies)) :
                                                    foreach ($companies as $value) : ?>
                                                        <li><a class="dropdown-item navbar-text" href="/companies/<?= $value ?>"><?= $value ?></a></li>
                                                    <?php endforeach; ?>
                                                <?php endif; ?>
                                            </ul>
                                        </li>
            ...
            <?php if (empty($_REQUEST['route']) || $_REQUEST['route'] != 'companies') include __DIR__ . '/leftSidebar.php' ?>